...
import abbrevIcon from '../../../../icons/abbreviation.svg';
...
export default class AbbreviationUI extends Plugin {
	...
	init() {
		...
		const abbrevCommand = editor.commands.get('addAbbreviation');
		...
		editor.ui.componentFactory.add( 'abbreviation', (locale) => {
			...
			button.bind('isOn', 'isEnabled').to(abbrevCommand, 'value', 'isEnabled');
    ...
    // Remove the abbr tag after clicking the "Remove" button.
